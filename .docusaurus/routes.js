...
export default [
  ...
  {
    path: '/docs',
    component: ComponentCreator('/docs', '8d3'),
    routes: [
      {
        path: '/docs',
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: '/docs/eRob_developer/congratulations',
                component: ComponentCreator('/docs/eRob_developer/congratulations', '05f'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/eRob_developer/create-a-document',
                component: ComponentCreator('/docs/eRob_developer/create-a-document', '7f4'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
                path: '/docs/eRob_developer/deploy-your-site',
                component: ComponentCreator('/docs/eRob_developer/deploy-your-site', 'eac'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
              ...
              {
                path: '/docs/eRob_developer/markdown-features',
                component: ComponentCreator('/docs/eRob_developer/markdown-features', '06f'),
                exact: true,
                sidebar: "tutorialSidebar"
              },
              {
